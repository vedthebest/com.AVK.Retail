...
using DAL;
using AVK.Web.ViewModels;
using AutoMapper;
using DAL.Models;
using Microsoft.Extensions.Logging;
using AVK.Web.Helpers;
using Microsoft.Extensions.Options;

namespace AVK.Web.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<string> Email()
        {
            ...
            string recepientEmail = "vedthebest@gmail.com"; //   <===== Put the recepient's email here

            string message = EmailTemplates.GetTestEmail(recepientName, DateTime.UtcNow);

            (bool success, string errorMsg) = await _emailer.SendEmailAsync(recepientName, recepientEmail, "Test Email from AVK.Web", message);
